...
export const metadata = {
  title: 'Shavat | 1 Chronicles',
  description: '1 Chronicles',
};

export default function FirstChroniclesPage() {
  const divisions = getAllDivisions('1-chronicles');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/1-chronicles/${division.id}/${division.chapters[0]}`}
