...
export const metadata = {
  title: 'Shavat | 1 Peter',
  description: '1 Peter - Living as exiles with hope',
};

export default function FirstPeterPage() {
  const divisions = getAllDivisions('1-peter');
    ...
    <main className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-base text-[rgb(var(--text-secondary))] leading-relaxed mb-6">
          Peter writes to scattered believers facing suffering and marginalization, reminding them of their identity as God's chosen people and calling them to holy living as exiles. First Peter grounds Christian hope in the resurrection and demonstrates how the gospel transforms both suffering and social relationships.
        </p>
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/nt/1-peter/${division.id}/${division.chapters[0]}`}
