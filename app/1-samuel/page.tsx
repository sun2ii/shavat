...
export const metadata = {
  title: 'Shavat | 1 Samuel',
  description: '1 Samuel',
};

export default function FirstSamuelPage() {
  const divisions = getAllDivisions('1-samuel');
    ...
    <main className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-base text-[rgb(var(--text-secondary))] leading-relaxed mb-6">
          First Samuel chronicles Israel's transition from judges to monarchy, following Samuel the prophet, Saul the failed king, and David the man after God's own heart. The book demonstrates that true kingship requires submission to God's word and dependence on his Spirit.
        </p>
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/1-samuel/${division.id}/${division.chapters[0]}`}
