...
export const metadata = {
  title: 'Shavat | 1 Thessalonians',
  description: '1 Thessalonians',
};

export default function FirstThessaloniansPage() {
  const divisions = getAllDivisions('1-thessalonians');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/nt/1-thessalonians/${division.id}/${division.chapters[0]}`}
