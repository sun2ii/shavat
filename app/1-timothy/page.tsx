...
export const metadata = {
  title: 'Shavat | 1 Timothy',
  description: '1 Timothy',
};

export default function FirstTimothyPage() {
  const divisions = getAllDivisions('1-timothy');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/nt/1-timothy/${division.id}/${division.chapters[0]}`}
