...
export const metadata = {
  title: 'Shavat | 2 Chronicles',
  description: '2 Chronicles',
};

export default function SecondChroniclesPage() {
  const divisions = getAllDivisions('2-chronicles');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/2-chronicles/${division.id}/${division.chapters[0]}`}
