...
export const metadata = {
  title: 'Shavat | 2 Samuel',
  description: '2 Samuel',
};

export default function SecondSamuelPage() {
  const divisions = getAllDivisions('2-samuel');
    ...
    <main className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-base text-[rgb(var(--text-secondary))] leading-relaxed mb-6">
          Second Samuel narrates David's reign as king of Israel, including his triumphs and failures. The Davidic covenant establishes the promise of an eternal throne, pointing forward to the Messiah, while David's sin with Bathsheba demonstrates that even the man after God's own heart stands in need of grace.
        </p>
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/2-samuel/${division.id}/${division.chapters[0]}`}
