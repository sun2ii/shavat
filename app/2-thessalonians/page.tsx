...
export const metadata = {
  title: 'Shavat | 2 Thessalonians',
  description: '2 Thessalonians',
};

export default function SecondThessaloniansPage() {
  const divisions = getAllDivisions('2-thessalonians');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/nt/2-thessalonians/${division.id}/${division.chapters[0]}`}
