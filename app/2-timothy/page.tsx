...
export const metadata = {
  title: 'Shavat | 2 Timothy',
  description: '2 Timothy',
};

export default function SecondTimothyPage() {
  const divisions = getAllDivisions('2-timothy');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/nt/2-timothy/${division.id}/${division.chapters[0]}`}
