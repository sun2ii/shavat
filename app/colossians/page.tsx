...
export const metadata = {
  title: 'Shavat | Colossians',
  description: 'Colossians',
};

export default function ColossiansPage() {
  const divisions = getAllDivisions('colossians');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/nt/colossians/${division.id}/${division.chapters[0]}`}
