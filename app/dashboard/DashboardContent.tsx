  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 mb-6">
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 font-sans text-xs md:text-[11px]">
        ...
        {currentReading && (
          <>
            ...
            <Link
              ...
              className="inline-block py-1 font-sans text-xs md:text-[11px] text-muted hover:text-gold active:text-gold transition-colors"
            >
