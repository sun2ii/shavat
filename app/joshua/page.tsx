...
export const metadata = {
  title: 'Shavat | Joshua',
  description: 'Joshua - Conquest and inheritance of the Promised Land',
};

export default function JoshuaPage() {
  const divisions = getAllDivisions('joshua');
    ...
    <main className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-base text-[rgb(var(--text-secondary))] leading-relaxed mb-6">
          Joshua chronicles Israel's conquest of Canaan under Joshua's leadership, demonstrating God's faithfulness to give his people the land promised to Abraham. The book shows that entering God's rest requires faith and obedience, patterns that Hebrews applies to the Christian life.
        </p>
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/joshua/${division.id}/${division.chapters[0]}`}
