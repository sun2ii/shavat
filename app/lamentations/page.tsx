...
export const metadata = {
  title: 'Shavat | Lamentations',
  description: 'Lamentations',
};

export default function LamentationsPage() {
  const divisions = getAllDivisions('lamentations');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/lamentations/${division.id}/${division.chapters[0]}`}
