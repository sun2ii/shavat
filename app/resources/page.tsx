...
const CATEGORIES = [
  { title: 'Reading Plans', description: 'Paths through Scripture for steady daily reading.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="stroke-ink" strokeWidth="1.1"><path d="M12 6 C10 4.6 7 4.3 4 5 V18 C7 17.3 10 17.6 12 19 C14 17.6 17 17.3 20 18 V5 C17 4.3 14 4.6 12 6 Z M12 6 V19 M6.5 8.5 C8 8.1 9.5 8.2 10.5 8.7 M6.5 11 C8 10.6 9.5 10.7 10.5 11.2 M13.5 8.7 C14.5 8.2 16 8.1 17.5 8.5 M13.5 11.2 C14.5 10.7 16 10.6 17.5 11" /></svg> },
  { title: 'Study Guides', description: 'Structured helps for deeper understanding.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="stroke-ink" strokeWidth="1.1"><rect x="5" y="3.5" width="12" height="17" rx="1.4" /><path d="M5 6.5 H3.8 M5 9.5 H3.8 M5 12.5 H3.8 M5 15.5 H3.8 M8 8 H14 M8 11 H14 M8 14 H12" /><path d="M15.5 20.5 L19.5 12.5 L21 13.3 L17 21.2 L15.2 21.6 Z" /></svg> },
  { title: 'Theme Collections', description: 'Grouped passages connecting the bigger story.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="stroke-ink" strokeWidth="1.1"><path d="M4 17 L14 15.5 L14.5 18.5 L4.5 20 Z M4.5 13 L14.5 12 L14.8 15 L4.8 16 Z M5 9 L15 8.5 L15.2 11.5 L5.2 12 Z" /><path d="M14 15.5 L18 14 M14.5 12 L18.5 10.8 M15 8.5 L19 7.5" /></svg> },
  { title: 'Getting Started', description: 'Introductions for new readers.', icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="stroke-ink" strokeWidth="1.1"><circle cx="12" cy="12" r="8.5" /><circle cx="12" cy="12" r="1.1" /><path d="M12 3.5 V5 M12 19 V20.5 M3.5 12 H5 M19 12 H20.5" /><path d="M15.5 8.5 L13 11 L11 13 L8.5 15.5 L11 13 Z M15.5 8.5 L13 13 L8.5 15.5 L11 11 Z" /></svg> },
];
    ...
    <div className="font-inter min-h-screen flex flex-col bg-paper text-ink">
      ...
      <section className="px-4 sm:px-8 md:px-12 pb-6 sm:pb-7">
        <div className="bg-surface dark:bg-surface border-t border-hairline rounded-lg flex flex-col sm:flex-row items-center gap-4 sm:gap-5 p-4 sm:p-5 md:px-8">
          <span className="flex-none w-10 h-10 sm:w-12 sm:h-12 border-[1.5px] border-gold rounded-full flex items-center justify-center bg-paper dark:bg-surface">
            <svg width="18" height="20" viewBox="0 0 34 38" fill="none" className="stroke-gold" strokeWidth="1.4">
              <path d="M17 36 V14" />
