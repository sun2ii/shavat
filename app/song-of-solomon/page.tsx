...
export const metadata = {
  title: 'Shavat | Song of Solomon',
  description: 'Song of Solomon',
};

export default function SongOfSolomonPage() {
  const divisions = getAllDivisions('song-of-solomon');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          {divisions.map((division) => (
            <Link
              key={division.id}
              href={`/ot/song-of-solomon/${division.id}/${division.chapters[0]}`}
