  ...
  return (
    <>
      ...
      <nav className="relative flex flex-col items-center justify-center mb-6 pb-3 border-b border-[rgb(var(--border))]">
        ...
        <span className="absolute left-0 top-0 text-xs text-[rgb(var(--text-secondary))] opacity-50">
          Ps {currentPsalm}
        </span>
        ...
        <div className="flex gap-3 mt-3">
          {collection.psalms.map((psalmNum, idx) => {
            const isActive = psalmNum === currentPsalm;
            return (
              <Link
                key={psalmNum}
